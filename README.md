...
We assume there are 2 parameters in each sigmoid funciton need to be tailored for ECDF points. c & a in c(x-a) in function. In "fit.cpp", real_1d_array c has the initial values for c & a. (c[0] stands for c, c[1] stands for a).
