...
void function_cx_1_func(const real_1d_array &c, const real_1d_array &x, double &func, void *ptr)
{
    ...
    func = 1 - (1.0 / (1.0 + exp(-c[0] * (x[0]-c[1]))));
}
...
void Hyperbolic_tangent_func(const real_1d_array &c, const real_1d_array &x, double &func, void *ptr)
{
    ...
    // x = c[0] * (x[0] - c[1])
    func = 1 - (((exp(c[0] * (x[0] - c[1])) - exp(-c[0] * (x[0] - c[1])))/(exp(c[0] * (x[0] - c[1])) + exp(-c[0] * (x[0] - c[1]))) + 1) / 2);
}
...
void function_cx_1_func(const real_1d_array &c, const real_1d_array &x, double &func, void *ptr)
{
    func = 1 - ((2* atan(tanh(c[0] * (x[0] - c[1])/ 2))) + 1) / 2);
}
...
void function_cx_1_func(const real_1d_array &c, const real_1d_array &x, double &func, void *ptr)
{
    ...
    func = 1 - (((c[0] * (x[0] - c[1]) / sqrt(1 + x[0] * x[0])) + 1) / 2);
}
